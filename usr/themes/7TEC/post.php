...
<div class="col-sm-12 col-lg-8" id="main" role="main">
	<article class="post Card typo" itemscope itemtype="http://schema.org/BlogPosting">
		...
		<div class="tags-box paddingall">
			版权声明：如无特别说明，本文为作者原创，转载请在首行注明来源：<a href="<?php $this->permalink(); ?>"><?php $this->permalink(); ?></a>
		</div>
		<div class="info">
			<ul class="post-meta">
				...
				<li><i class="fa fa-hand-o-up" aria-hidden="true">&nbsp; </i><span><?php get_post_view($this);
																					_e(' 次浏览'); ?></span></li>
			</ul>
		</div>
